          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="order-2 lg:order-1 bg-gradient-to-br from-primary/5 to-secondary/10 rounded-2xl p-8 lg:p-12 h-full flex flex-col justify-center">
              ...
              <div className="space-y-6">
                {[
                  { title: 'Profile-aware guidance', desc: 'Your preferences and history stay with you' },
                  { title: 'Secure account-based access', desc: 'Your data is protected and private' },
                  { title: 'Tier-based features in one place', desc: 'Access everything your plan includes' },
                ].map((point) => (
