...
export function RegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const emailExists = formData.email === 'test@example.com';

      if (emailExists) {
        setServerError('This email is already registered. Please login or use a different email.');
      ...
      <div className="bg-card rounded-2xl p-8 lg:p-12 border border-border shadow-sm">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-muted-foreground mb-8">
            Next: complete your profile to start using Mazaj+
          </p>
          <button 
